...
class formulir_1111_a2(osv.osv):
    ...
    _columns =  {
                ...
                'company_id' : fields.many2one(string='Perusahaan', obj='res.company', required=True, readonly=True, states={'draft':[('readonly',False)]}), #TODO: Ticket #54
                'nama_pkp' : fields.char(string='Nama PKP', size=255, required=True, readonly=True, states={'draft':[('readonly',False)]}), #TODO: Ticket #54
                'npwp' : fields.char(string='NPWP', size=50, required=True, readonly=True, states={'draft':[('readonly',False)]}), #TODO: Ticket #54
                'masa_pajak_id' : fields.many2one(string='Masa Pajak', obj='pajak.masa_pajak', required=True, readonly=True, states={'draft':[('readonly',False)]}), #TODO: Ticket #54
                'pembetulan_ke' : fields.integer(string='Pembetulan Ke-', required=True, readonly=True, states={'draft':[('readonly',False)]}), #TODO: Ticket #54
                'detail_ids' : fields.one2many(string='Detail', obj='pajak.detail_formulir_1111_a2', fields_id='formulir_id', readonly=True, states={'draft':[('readonly',False)]}), #TODO: Ticket #54
