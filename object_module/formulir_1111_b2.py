...
class formulir_1111_b2(osv.osv):
    ...
    def function_amount_all(self, cr, uid, ids, name, args, context={}):
        ...
        obj_pajak_formulir_1111_b2_detail = self.pool.get('pajak.detail_formulir_1111_b2')
        
        for formulir in self.browse(cr, uid, ids):
            kriteria = [('formulir_id', '=', formulir.id)]
            detail_ids = obj_pajak_formulir_1111_b2_detail.search(cr, uid, kriteria)
            if detail_ids:
                for detail in obj_pajak_formulir_1111_b2_detail.browse(cr, uid, detail_ids):
    ...
    _columns =  {
                                ...
                                'company_id' : fields.many2one(string='Perusahaan', obj='res.company', required=True), #TODO: Ticket #67
                                'nama_pkp' : fields.char(string='Nama PKP', size=255, required=True), #TODO: Ticket #67
                                'npwp' : fields.char(string='NPWP', size=50, required=True), #TODO: Ticket #67
                                'masa_pajak_id' : fields.many2one(string='Masa Pajak', obj='pajak.masa_pajak', required=True), #TODO: Ticket #67
                                'pembetulan_ke' : fields.integer(string='Pembetulan Ke-', required=True), #TODO: Ticket #67
                                'detail_ids' : fields.one2many(string='Detail', obj='pajak.detail_formulir_1111_b2', fields_id='formulir_id'), #TODO: Ticket #67
