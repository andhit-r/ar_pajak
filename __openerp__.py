...
Accounting connection will be handle on additional module.
    ...
    'data' : [  
                    ...
                    'window_action/waction_JenisTransaksiFakturPajak.xml',
                    'window_action/waction_StatusFakturPajak.xml',
