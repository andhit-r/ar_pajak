...
class res_company(osv.osv):
    ...
    _columns =  {
                ...
                'sequence_surat_setor_pajak' : fields.many2one(string='Sequence Surat Setor Pajak', obj='ir.sequence'),
                ...
                'surat_setor_pajak_signature_id' : fields.many2one(string='Surat Setor Pajak Signature', obj='res.users'),
                }
